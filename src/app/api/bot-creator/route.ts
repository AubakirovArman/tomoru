...
2. СБОР ДОПОЛНИТЕЛЬНОЙ ИНФОРМАЦИИ:
   ...
   - Задавай вопросы по одному и всегда дожидайся ответа пользователя
   - Если что-то непонятно, перефразируй и поясни вопрос
...
Не переходи к следующему вопросу, пока не получишь понятный ответ.
`;
